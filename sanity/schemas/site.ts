...
export const site = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "heroKnopPrimair",
      title: "Tekst op de amberkleurige knop",
      description: "Staat ook rechtsboven in de menubalk.",
      type: "string",
      group: "hero",
    ...
    defineField({
      name: "heroKnopSecundair",
      title: "Tekst op de tweede knop",
      type: "string",
      group: "hero",
      initialValue: "Bekijk de pakketten",
      validation: (Rule) => Rule.required().max(24),
    }),
    defineField({
      name: "heroPaneelTitel",
      title: "Label boven het zwevende paneel",
      type: "string",
      group: "hero",
      initialValue: "Waarom hier",
      validation: (Rule) => Rule.required().max(24),
    }),
    defineField({
      name: "heroPunten",
